...
pub struct ApiResponse<TBody: Serialize = ()> {
    /// Response metadata
    ///
...
pub struct ApiResponseMeta {
    ...
    #[serde(rename = "status", with = "status_code_serializer")]
...
#[serde(rename_all = "camelCase")]
pub enum ApiResponseBody<TData: Serialize = ()> {
...
impl<TData: Serialize> ApiResponse<TData> {
    ...
    pub fn with_body(mut self, body: ApiResponseBody<TData>) -> ApiResponse<TData> {
        self.body = body;
        self
    }

    pub fn with_success_body(self, body: TData) -> ApiResponse<TData> {
        self.with_body(ApiResponseBody::Success(body))
    }

    pub fn with_error_body(self, error: ApiError) -> ApiResponse<TData> {
